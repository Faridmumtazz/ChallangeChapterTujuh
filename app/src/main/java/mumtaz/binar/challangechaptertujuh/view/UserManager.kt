...
class UserManager (context: Context) {
    ...
    private val dataStore : DataStore<androidx.datastore.preferences.Preferences> = context.createDataStore("user")
    private val loginDS : DataStore<androidx.datastore.preferences.Preferences> = context.createDataStore("login")
